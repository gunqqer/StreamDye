...
constexpr char seperator[]{";"};  // Used after prefix and code to add more codes in special ways, mostly for internal
								 // use
constexpr char clear[]{"\033[0m"}; // resets all effects, output this to a stream to clear all ANSI codes (should use
								   // StreamDye::resetAll())
...
inline std::string effect(Effect e) // If used, you must either remember the effect used or use resetAll() to turn it
									// off
{
	std::stringstream output;
