...
int main()
{
	...
	printTest.push_back(std::make_pair(StreamDye::printColor(testString, StreamDye::Color::red), "Red"));
	printTest.push_back(std::make_pair(StreamDye::printEffect(testString, StreamDye::Effect::bold), "Bold"));
	printTest.push_back(std::make_pair(StreamDye::printEffect(testString, StreamDye::Effect::blinkSlow), "Blinking"));
